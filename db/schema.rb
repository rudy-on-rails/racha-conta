...
ActiveRecord::Schema.define(:version => 20131010130605) do
  ...
  add_index "account_shares", ["token"], :name => "index_account_shares_on_token", :unique => true
  ...
  add_index "shared_accounts", ["user_id", "account_id"], :name => "index_shared_accounts_on_user_id_and_account_id", :unique => true
